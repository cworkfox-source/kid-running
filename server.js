...
const allowed=/^(index.html|styles.css|app.js|core.js|db.js|sw.js|auth.js|backup.js|restore.js|firebase.js|firebase-config.js|firebase-config.local.js|firebase-config.example.js|cloud.js)$/;
